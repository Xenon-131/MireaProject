...
import ru.mirea.egorovakv.mireaproject.databinding.FragmentWeatherBinding;
...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.buttonGetWeather.setText("update location");

        binding.buttonGetWeather.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //get location info
                if(binding.buttonGetWeather.getText() == "update location"){
                    ...
                    if (networkinfo != null && networkinfo.isConnected()) {
                        ...
                        binding.buttonGetWeather.setText("show weather");
    ...
    private class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            binding.textViewCoordinates.setText("In progress...");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                binding.textViewCoordinates.setText("Location\nlatitude: "+words[0]+"\nlongitude: "+words[1]);
                latitude = words[0];
                longitude = words[1];
